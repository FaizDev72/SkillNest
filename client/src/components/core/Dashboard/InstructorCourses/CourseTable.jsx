...
import { deleteCourse, fetchInstructorCourses } from "../../../../services/operations/courseDetailAPIs";
...
const CourseTable = ({ courses, setCourses }) => {
    ...
    async function courseDeleteHandler(course_id) {
        setLoading(true)
        await deleteCourse(course_id, token)
                                ...
                                <Tr key={course._id} className='flex gap-x-10 border-b border-richblack-800 px-6 py-8'>
                                    <Td className='flex flex-1 gap-x-4'>
                                        ...
                                        <div className='flex flex-col justify-between'>
                                            <p className='text-lg font-semibold text-richblack-5'>{course?.course_name}</p>
                                            <p className="text-sm text-richblack-300">{course?.description.split(" ").length > TRUNCATE_LENGTH
                                                ? course.description
                                                    .split(' ')
