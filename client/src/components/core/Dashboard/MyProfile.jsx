      ...
      <div className='flex items-center justify-between rounded-md border-[1px] border-richblack-700 bg-richblack-800 p-8 px-12'>
        <div className='flex justify-between items-center gap-4 w-full'>
          <div className='flex items-center justify-center gap-4'>
            <img src={user?.profile?.image} alt='ProfileImage' className='aspect-square w-[78px] rounded-full object-cover' />
            <div className='flex flex-col'>
              <span className='text-lg font-semibold text-richblack-5'>{user?.first_name + " " + user?.last_name}</span>
              <span className='text-sm text-richblack-300'>{user?.email}</span>
            </div>
          </div>
          <div>
            <IconBtn
        ...
        <div className="flex max-w-[500px] justify-between">
          ...
          <div className="flex flex-col gap-y-5">
            ...
            <div>
              ...
              <p className="text-sm font-medium text-richblack-5">
                {user?.profile?.dateOfBirth ?? "Add Date Of Birth"}
              </p>
            </div>
          </div>
